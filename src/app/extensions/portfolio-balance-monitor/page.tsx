      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Real-time portfolio balance monitoring directly in VS Code. Track
            your investment accounts and get instant updates on your total
            portfolio value without leaving your development environment.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-300">
                Get live updates of your portfolio balance in the VS Code status
                bar. No need to switch windows or refresh browsers—stay focused
                on coding while monitoring your investments.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Connect multiple investment accounts from Robinhood and other
                brokers. View consolidated balance across all accounts at a
                glance.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Always-visible status bar widget shows your current portfolio
                value. Click to expand for detailed account breakdown.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Your credentials are never stored. We use OAuth 2.0 and secure
                API connections for safe account access.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Search for &quot;Portfolio Balance Monitor&quot; in the VS
                  Code Extensions marketplace and click Install.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Open the extension settings and authenticate with your
                  Robinhood or other supported broker. You&apos;ll be redirected
                  to their secure login.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Your balance appears instantly in the status bar at the bottom
                  of VS Code. Updates refresh every 30 seconds (configurable).
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Choose update frequency, currency display format, and which
                  accounts to display. All preferences saved locally.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-slate-400 text-sm mt-2">
                Full support for stock & crypto balances
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-3">💰</div>
          ...
          <div className="space-y-4">
            <details className="group cursor-pointer">
              <summary className="flex items-center gap-4 p-6 bg-slate-800 rounded-lg border border-slate-700 group-open:bg-slate-700 transition">
                ...
                <span className="ml-auto text-slate-400 group-open:rotate-180 transition">
                  ▼
                </span>
              </summary>
              <p className="p-6 text-slate-300">
                Yes! We never store your credentials locally. All communication
                uses encrypted OAuth 2.0 with broker APIs. Your data never
            ...
            <details className="group cursor-pointer">
              ...
              <p className="p-6 text-slate-300">
                The extension caches your last balance locally. Once you&apos;re
                back online, it will update automatically.
              </p>
            </details>
            ...
            <details className="group cursor-pointer">
              ...
              <p className="p-6 text-slate-300">
                Default is every 30 seconds, but you can configure it from 10
                seconds to 5 minutes in settings.
              </p>
            </details>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-500/20 to-emerald-600/20 border border-green-500/50 rounded-xl p-12 text-center">
          ...
          <p className="text-slate-300 mb-8">
            Install Portfolio Balance Monitor today and never lose focus on your
            investments again.
          </p>
          <a
            href="https://chromewebstore.google.com/detail/niddlfmemgoikmfmhkccjefejcodaljk?utm_source=item-share-cb"
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-lg p-6 text-center hover:border-slate-500 transition">
              ...
              >
                ...
                <input
                  type="hidden"
                  name="item_name"
                  value="Portfolio Balance Monitor - Non-Profit Support"
                />
