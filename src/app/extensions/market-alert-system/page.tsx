      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <p className="text-xl text-slate-300 mb-8">
            Intelligent market alerts and price notifications. Receive timely
            alerts on stock movements, market conditions, and price targets you
            care about—all without leaving VS Code.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-300">
                Set price targets for any stock. Get notified instantly when a
                stock reaches your target price, whether it&apos;s above or
            ...
            <div>
              ...
              <p className="text-slate-300">
                Receive desktop notifications, status bar indicators, and
                optional sound alerts. Never miss important market movements
                again.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Create custom watchlists for different sectors or strategies.
                Organize and manage multiple alerts for hundreds of stocks
                effortlessly.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Set alerts for market conditions like S&P 500 movements, VIX
                levels, or sector performance changes.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Receive alerts via VS Code notification, email, webhook, or
                custom integrations. Choose how you want to be notified.
              </p>
            </div>
            <div>
              ...
              <p className="text-slate-300">
                Filter alerts by time of day, volume changes, percentage moves,
                or custom conditions to reduce notification noise.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">
                    Alert when stock price hits your target. Set separate
                    thresholds for buy signals and take-profit levels.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">
                    Get notified when a stock moves up or down by a specific
                    percentage from its opening price or previous close.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">
                    Monitor trading volume and get alerted when volume spikes
                    above average, indicating potential price movements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">
                    Track RSI, MACD, Moving Averages and get alerts when
                    indicators cross thresholds or form patterns.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">
                    Monitor market indices, sectors, or economic indicators. Get
                    broad market context for your individual stock alerts.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-300 text-sm">
                    Get notified when major news breaks about companies in your
                    watchlist. Integrated with financial news sources.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-xl p-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">
                  Open the Alert Panel
                </h3>
                <p className="text-slate-300">
                  Click the alert bell icon in the VS Code sidebar to open the
                  Market Alert System panel.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white mb-2">
                  Add a Stock or Index
                </h3>
                <p className="text-slate-300">
                  Search and add the stock symbol or index you want to monitor.
                  Add to an existing watchlist or create a new one.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Set your alert conditions: price targets, percentage changes,
                  volume surges, or technical indicators.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Select how you want to be notified: VS Code popup, sound
                  alert, email, or webhook integration.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Save your alert and start monitoring. The extension runs
                  continuously in the background and notifies you instantly.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300 text-sm">
                Standard VS Code notification popup with alert details and quick
                actions.
              </p>
            </div>
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300 text-sm">
                Optional audio cue to grab your attention (customizable volume
                and sound).
              </p>
            </div>
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300 text-sm">
                Send alert details to your email with chart snapshots and
            ...
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300 text-sm">
                Send alerts to custom webhooks for integration with trading bots
                or other systems.
              </p>
            </div>
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300 text-sm">
                Send alerts directly to your Slack channel for team
                notifications.
              </p>
            </div>
            <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
              ...
              <p className="text-slate-300 text-sm">
                Mobile push notifications via VS Code companion mobile app
                (coming soon).
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">
                  Minimal impact on VS Code performance with optimized
            ...
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">
                  Your watchlists and alert preferences stored locally. No data
                  sold or shared.
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">
                  Control how frequently alerts are checked (1 second to 5
                  minutes).
                </p>
              </div>
            </div>
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">
                  Automatic backup of your alerts and preferences to cloud
                  storage.
                </p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-500/20 to-red-600/20 border border-orange-500/50 rounded-xl p-12 text-center">
          ...
          <p className="text-slate-300 mb-8">
            Set intelligent alerts and stay informed about the stocks and
            ...
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-lg p-6 text-center hover:border-slate-500 transition">
              ...
              >
                ...
                <input
                  type="hidden"
                  name="item_name"
                  value="Market Alert System - Non-Profit Support"
                />
